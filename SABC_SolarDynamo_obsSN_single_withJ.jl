...
elseif from_previous == 1
	# --- Output file name ---
	fname = "obsSN_single_j1d"
	# --- Continue from... ---
	fname_previous = "obsSN_single_j1c"
	# --- Run ---
	fasa = deserialize(outdir * "SABCresult_" * fname_previous)
	out = update_population!(fasa, f_dist, prior; n_simulation = 1_000_000_000, 
							show_checkpoint = 500, v = 1.0,
