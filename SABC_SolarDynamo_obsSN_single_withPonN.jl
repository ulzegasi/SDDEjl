...
SNdata_temp = Matrix(CSV.read(datadir * "silso_SN_y_202601.csv", DataFrame, header=false))[:,2]
SNyrs_temp = Matrix(CSV.read(datadir * "silso_SN_y_202601.csv", DataFrame, header=false))[:,1]
# ------------------------------------------------------
# IMPORTANT 1: 
...
# WITHOUT TORQUE DATA -> TIDAL FORCES
# We can cover the time span (1700-2025)

SNyrs = SNyrs_temp # 1700-2025
SNdata = SNdata_temp
