module SDDESolarDynamo_withPlanetsOnN_C14

"""
Include the following lines in the main script:
---
include("./SDDESolarDynamo_withPlanetsOnN_C14.jl")
using .SDDESolarDynamo_withPlanetsOnN_C14
---
"""
...
# --- Load torque data
# torque_data = CSV.read(joinpath(@__DIR__, "torque_for_SABC_for_C14.csv"), DataFrame, header=false)
tidal_data = CSV.read(joinpath(@__DIR__, "tides_for_SABC_for_C14.csv"), DataFrame, header=false)
